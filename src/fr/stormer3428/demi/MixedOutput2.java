...
public class MixedOutput2 {
	...
	private static HashMap<Long, String> buffer = new HashMap<>();
	...
	public MixedOutput2(String channelID, boolean channel, boolean console, String header) {
		if(io == null) {
	...
	public MixedOutput2(String channelID, boolean console, String header) {
